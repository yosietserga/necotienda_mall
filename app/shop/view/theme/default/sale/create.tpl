                    ...
                    <form action="<?php echo str_replace('&', '&amp;', $action); ?>" method="post" enctype="multipart/form-data" id="formSale">
                      <div id="step1" style="position: relative;z-index:1;">
                        ...
                        <div id="step2" style="display:none;">
                            <h1>02. Selecciona Las Categor&iacute;as</h1>
                        ...
                        <div id="step3" style="display:none;">
                            <h1>03. Describe Tu Anuncio</h1>
                                ...
                                <div class="row">
                                    <input type="text" id="name" name="name" value="<?php echo ($name) ? $name : ''; ?>" required="required" placeholder="Ingresa el nombre del producto o servicio" width="90%" />
                                </div>

                                <div class="clear"></div>
                                <?php /**
                                <div class="row">
                                    <label for="">Modelo (Solo Productos):</label>
                                    <input type="text" id="model" name="model" value="Servicio" />
                                </div>

                                <div class="clear"></div>
                                
                                <div class="row">
                                    <label for="">Resumen del Art&iacute;culo</label>
...
<script>
var CKEDITOR_BASEPATH = '/assets/js/vendor/ckeditor/';

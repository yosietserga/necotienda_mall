...
class ControllerAccountEdit extends Controller {
    ...
    public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            if (!$this->modelCustomer->getProperty($this->customer->getId(), 'rewards', 'account_updated') && $this->customer->isLogged()) {
                $this->modelCustomer->setProperty($this->customer->getId(), 'rewards', 'account_updated', 1);

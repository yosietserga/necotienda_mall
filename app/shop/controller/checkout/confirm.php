...
class ControllerCheckoutConfirm extends Controller {
    ...
    public function index() {
        ...
        if ($order_id) {
            ...
            if (!$this->modelCustomer->getProperty($this->customer->getId(), 'rewards', 'first_order') && $this->customer->isLogged()) {
                $this->modelCustomer->setProperty($this->customer->getId(), 'rewards', 'first_order', 1);
                $this->modelCustomer->addNecopoints($this->customer->getId(), 5);
                $this->modelCustomer->addNecoexp($this->customer->getId(), 25);
            }

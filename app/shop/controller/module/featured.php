...
class ControllerModulefeatured extends Controller {
    ...
    protected function index($widget = null) {
        ...
        if ($widget['position'] == 'main' || $widget['position'] == 'featuredContent') {
            if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/module/featured_home.tpl')) {
                $this->template = $this->config->get('config_template') . '/module/featured_home.tpl';
            } else {
                $this->template = 'default/module/featured_home.tpl';
            }
        } else {
            if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/module/featured.tpl')) {
                ...
                $this->template = 'default/module/featured.tpl';
            }
        }
        $this->render();
    }

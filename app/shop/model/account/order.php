...
class ModelAccountOrder extends Model {
    ...
    public function getTotalSalesByCustomerId($id) {
    ...
    public function getTotalSalesWaitingByCustomerId($id) {
        $query = $this->db->query("SELECT COUNT(*) AS total "
                . "FROM " . DB_PREFIX . "order_product op "
                . "LEFT JOIN " . DB_PREFIX . "product p ON (p.product_id=op.product_id) "
                . "LEFT JOIN " . DB_PREFIX . "order o ON (o.order_id=op.order_id) "
                . "WHERE p.owner_id = '" . (int) $id . "' "
                . "AND order_status_id IN (1, 2, 5, 4) ");

        return $query->row['total'];
    }

    public function getTotalSalesCompleteByCustomerId($id) {
        $query = $this->db->query("SELECT COUNT(*) AS total "
                . "FROM " . DB_PREFIX . "order_product op "
                . "LEFT JOIN " . DB_PREFIX . "product p ON (p.product_id=op.product_id) "
                . "LEFT JOIN " . DB_PREFIX . "order o ON (o.order_id=op.order_id) "
                . "WHERE p.owner_id = '" . (int) $id . "' "
                . "AND order_status_id IN (3) ");

        return $query->row['total'];
    }

    public function getTotalSalesReturnsByCustomerId($id) {
        $query = $this->db->query("SELECT COUNT(*) AS total "
                . "FROM " . DB_PREFIX . "order_product op "
                . "LEFT JOIN " . DB_PREFIX . "product p ON (p.product_id=op.product_id) "
                . "LEFT JOIN " . DB_PREFIX . "order o ON (o.order_id=op.order_id) "
                . "WHERE p.owner_id = '" . (int) $id . "' "
                . "AND order_status_id IN (6) ");

        return $query->row['total'];
    }

    public function getTotalBuysByCustomerId($id) {
        $query = $this->db->query("SELECT COUNT(*) AS total "
                . "FROM " . DB_PREFIX . "order o "
    ...
    public function getTotalBuysWaitingByCustomerId($id) {
        $query = $this->db->query("SELECT COUNT(*) AS total "
                . "FROM " . DB_PREFIX . "order o "
                . "WHERE customer_id = '" . (int) $id . "' "
                . "AND order_status_id IN (1, 2, 5, 4) ");
    ...
    public function getTotalBuysCompleteByCustomerId($id) {
        $query = $this->db->query("SELECT COUNT(*) AS total "
                . "FROM " . DB_PREFIX . "order o "
                . "WHERE customer_id = '" . (int) $id . "' "
                . "AND order_status_id IN (3) ");
    ...
    public function getTotalBuysReturnsByCustomerId($id) {
        $query = $this->db->query("SELECT COUNT(*) AS total "
                . "FROM " . DB_PREFIX . "order o "
                . "WHERE customer_id = '" . (int) $id . "' "
                . "AND order_status_id IN (6) ");
    ...
    public function getTotalBuysNulledByCustomerId($id) {
        $query = $this->db->query("SELECT COUNT(*) AS total "
                . "FROM " . DB_PREFIX . "order o "
                . "WHERE customer_id = '" . (int) $id . "' "
                . "AND order_status_id IN (7) ");

...
<div class="box">
        ...
        <div class="buttons">
            <a onclick="saveAndExit();" class="button"><?php echo $Language->get('button_save_and_exit'); ?></a>
            <a onclick="saveAndKeep();" class="button"><?php echo $Language->get('button_save_and_keep'); ?></a>
            <a onclick="saveAndNew();" class="button"><?php echo $Language->get('button_save_and_new'); ?></a>
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
            ...
            <div class="row">
                <label><?php echo $Language->get('entry_contact'); ?></label>
                <?php if ($contacts) { ?>

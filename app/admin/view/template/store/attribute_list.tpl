    ...
    <div class="header">
        ...
        <form action="<?php echo $search; ?>" method="post" enctype="multipart/form-data" id="formFilter">  
            <div class="grid_11">
                ...
                <div class="row">
                    <label>Asociado a la Categor&iacute;a:</label>
                ...
                <div class="row">
                    ...
                    <select name="sort">
                        ...
                        <option value="a.name">Nombre del Grupo de Atributos</option>
                        <option value="cd.name">Nombre de la Categpr&iacute;a</option>
                        <option value="a.date_added">Fecha cuando se cre&oacute;</option>
                    </select>
                </div>
            </div>
...
<div class="clear"></div>
<?php if ($error_warning) { ?><div class="grid_24"><div class="message warning"><?php echo $error_warning; ?></div></div><?php }  if ($success) { ?><div class="grid_24"><div class="message success"><?php echo $success; ?></div></div><?php } ?>

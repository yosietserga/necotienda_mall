...
<div class="box">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
            ...
            <div class="row">
                <label><?php echo $Language->get('entry_test'); ?></label>
                <input type="checkbox" showquick="off" name="pp_standard_test" value="1"<?php if ($pp_standard_test) { ?> checked="checked"<?php } ?> />
            </div>
                    
            <div class="clear"></div>
               
            <div class="row">
                <label><?php echo $Language->get('entry_transaction'); ?></label>
                <select name="pp_standard_transaction">
                    <option value="0"<?php if (!$pp_standard_transaction) { ?> selected="selected"<?php } ?>><?php echo $Language->get('text_authorization'); ?></option>
                    <option value="1"<?php if ($pp_standard_transaction) { ?> selected="selected"<?php } ?>><?php echo $Language->get('text_sale'); ?></option>
                </select>
            </div>
            ...
            <div class="row">
                ...
                <select name="pp_standard_order_status_id">
                <?php foreach ($order_statuses as $order_status) { ?>
                    <option value="<?php echo $order_status['order_status_id']; ?>"<?php if ($order_status['order_status_id'] == $pp_standard_order_status_id) { ?> selected="selected"<?php } ?>><?php echo $order_status['name']; ?></option>
                <?php } ?>
                </select>
            </div>
            ...
            <div class="row">
                ...
                <select name="pp_standard_geo_zone_id">
                    ...
                    <option value="<?php echo $geo_zone['geo_zone_id']; ?>"<?php if ($geo_zone['geo_zone_id'] == $pp_standard_geo_zone_id) { ?> selected="selected"<?php } ?>><?php echo $geo_zone['name']; ?></option>
                    <?php } ?>
                </select>
            </div>
            ...
            <div class="row">
                ...
                <select title="<?php echo $Language->get('help_status'); ?>" name="pp_standard_status">
                    <option value="1"<?php if ($pp_standard_status) { ?> selected="selected"<?php } ?>><?php echo $Language->get('text_enabled'); ?></option>
                    <option value="0"<?php if (!$pp_standard_status) { ?> selected="selected"<?php } ?>><?php echo $Language->get('text_disabled'); ?></option>
                </select>
            </div>
            ...
            <div class="row">
                ...
                <input title="<?php echo $Language->get('help_sort_order'); ?>" type="text" name="pp_standard_sort_order" value="<?php echo $pp_standard_sort_order; ?>" style="width: 40%;" />
            </div>

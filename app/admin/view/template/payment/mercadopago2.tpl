...
<div class="box">
  ...
  <div class="content">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
       <tr><td></td><td><?php echo $Language->get('entry_ipn');?></td></tr>  
          <tr>
        ...
        <tr>
          <td><span class="required">*</span> <?php echo $Language->get('entry_client_id'); ?></td>
        ...
        <tr>
          <td><span class="required">*</span> <?php echo $Language->get('entry_client_secret'); ?></td>
          ...
          <tr>
          <td><span class="required">*</span> <?php echo $Language->get('entry_url'); ?></td>
          ...
          <tr>
          <td><span class="required">*</span> <?php echo $Language->get('entry_debug'); ?></td>
        ...
        <tr>
          <td><?php echo $Language->get('entry_installments'); ?></td>
        ...
        <?php if(isset($methods)){?>
          <tr>
          <td><?php echo $Language->get('entry_payments_not_accept'); ?></td>
          <td>
       ...
       <tr> 
        ...
        <tr>
        <td><?php echo $Language->get('entry_order_status_completed'); ?></td>
                ...
                <tr>
                  <td><?php echo $Language->get('entry_order_status_pending'); ?></td>
                 ...
                 <tr>
                  <td><?php echo $Language->get('entry_order_status_canceled'); ?></td>
                 ...
                 <tr>
                  <td><?php echo $Language->get('entry_order_status_in_process'); ?></td>
                 ...
                 <tr>
                  <td><?php echo $Language->get('entry_order_status_rejected'); ?></td>
                 ...
                 <tr>
                  <td><?php echo $Language->get('entry_order_status_refunded'); ?></td>
                 ...
                 <tr>
                  <td><?php echo $Language->get('entry_order_status_in_mediation'); ?></td>

...
<div class="box">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
            ...
            <div class="row">
                ...
                <select title="<?php echo $Language->get('help_status'); ?>" name="bank_transfer_status">
                    <option value="1"<?php if ($bank_transfer_status) { ?> selected="selected"<?php } ?>><?php echo $Language->get('text_enabled'); ?></option>
                    <option value="0"<?php if (!$bank_transfer_status) { ?> selected="selected"<?php } ?>><?php echo $Language->get('text_disabled'); ?></option>
                </select>
            </div>
            ...
            <div class="row">
                ...
                <input title="<?php echo $Language->get('help_sort_order'); ?>" type="text" name="bank_transfer_sort_order" value="<?php echo $bank_transfer_sort_order; ?>" style="width: 40%;" />
            </div>

        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
            ...
            <div class="row">
                <label><?php echo $Language->get('entry_payable'); ?></label>
                    <select name="debit_email_template" title="<?php echo $Language->get('help_email_template'); ?>">
            ...
            <div class="row">
                ...
                <select title="<?php echo $Language->get('help_status'); ?>" name="debit_status">
                    <option value="1"<?php if ($debit_status) { ?> selected="selected"<?php } ?>><?php echo $Language->get('text_enabled'); ?></option>
                    <option value="0"<?php if (!$debit_status) { ?> selected="selected"<?php } ?>><?php echo $Language->get('text_disabled'); ?></option>
                </select>
            </div>

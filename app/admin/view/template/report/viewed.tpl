    ...
    <thead>
          <tr>
            ...
            <td class="left"><?php if ($sort == 'model') { ?>
              <a href="<?php echo $sort_model; ?>" class="<?php echo strtolower($order); ?>"><?php echo $Language->get('column_model; ?></a>
              <?php } else { ?>
              <a href="<?php echo $sort_model; ?>"><?php echo $Language->get('column_model; ?></a>
              <?php } ?></td>

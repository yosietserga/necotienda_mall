 ...
 * @see Controller
 */
class ControllerModuleSearchWidget extends Controller {
	private $error = array(); 
	
	/**
	 * ControllerModuleSearchWidget::index()
	 * 
	 * @return
	 */
	public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST')) {
    		...
    		$this->template = 'module/search/widget.tpl';

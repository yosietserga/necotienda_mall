                ...
                <div class="content">
                    ...
                    <div class="sort">
                        <select name="sort" <?php echo (array_key_exists('ajax',$sorts[0])) ? "onchange='sort(this,this.value)' " : "onchange='window.location = this.value'"; ?>>
                          ...
                          <a class="view_style" href="<?php echo str_replace('&', '&amp;', $gridView); ?>" title="Ver en Miniaturas"  style="background-position:0 -23px">&nbsp;</a>    
                          <?php } else { ?>
                          <a class="view_style" href="<?php echo str_replace('&', '&amp;', $listView); ?>" title="Ver en Listado">&nbsp;</a>    
                          <?php } ?>
                    </div> 
                    <?php } ?>

...
class ControllerModuleRandom extends Controller {
	protected function index($widget=null) {
		...
		if ($widget['position'] == 'main' || $widget['position'] == 'featuredContent') {
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/module/random_home.tpl')) {
				$this->template = $this->config->get('config_template') . '/module/random_home.tpl';
			} else {
				$this->template = 'default/module/random_home.tpl';
			}
		} else {
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/module/random.tpl')) {
				$this->template = $this->config->get('config_template') . '/module/random.tpl';
			} else {
				$this->template = 'default/module/random.tpl';
			}
		}

...
class ControllerCheckoutCart extends Controller {
    ...
    protected function notify($order_id,$data) {
        // enviar información de pago y pasos a seguir configurados por el anunciante al comprador
        /**
         * 1. crear módulo de marketing del cliente donde pueda:
         *  - configurar cuentas de email para el envío de correos masivos
         ...
         *  - comprar módulos y extensiones para su tienda
         *      - auto publicar en las redes sociales
         *      - auto promocionar los productos nuevos
         *      - envío masivo de emails
         *      - 
         * */
        // enviar resumen del pedido al comprador con otras opciones del mismo artículo
        // enviar notificación de pedido nuevo al anunciante

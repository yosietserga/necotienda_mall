            ...
            if ($this->config->get('marketing_email_invite_friends')) {
                ...
                if ($newsletter) {
                    ...
                    $data = array(
                        ...
                        'name'          => 'Invitar Amigos de '. $this->db->escape(addslashes($userInfo->name)) .' en Google',
                        'subject'       => 'Hola',
                        'from_name'     => $this->db->escape(addslashes($userInfo->name)),
                        'from_email'    => $this->db->escape($userInfo->email),
                    ...
                    foreach ($to as $sort_order => $contact) {
                        if (in_array($contact['email'],$control)) continue;
